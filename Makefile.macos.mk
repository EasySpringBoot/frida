...
core-macos: build/tmp-macos-i386/frida-core/.frida-core-stamp build/tmp-macos-x86_64/frida-core/.frida-core-stamp ##@core Build for macOS
...
check-core-macos: build/tmp-macos-i386/frida-core/tests/frida-tests build/tmp-macos-x86_64/frida-core/tests/frida-tests ##@core Run tests for macOS
	build/tmp-macos-i386/frida-core/tests/frida-tests $(test_args)
	build/tmp-macos-x86_64/frida-core/tests/frida-tests $(test_args)
check-core-android-arm64: build/tmp-android-arm/frida-core/src/frida-helper build/tmp-android-arm64/frida-core/src/frida-helper build/tmp-android-arm/frida-core/lib/loader/.libs/libfrida-loader.so build/tmp-android-arm64/frida-core/lib/loader/.libs/libfrida-loader.so build/tmp-android-arm/frida-core/lib/agent/.libs/libfrida-agent.so build/tmp-android-arm64/frida-core/lib/agent/.libs/libfrida-agent.so
	. build/frida-env-android-arm64.rc \
		...
		&& make check \
			...
			HELPER32=../../../../build/tmp-android-arm/frida-core/src/frida-helper!frida-helper-32 \
			HELPER64=../../../../build/tmp-android-arm64/frida-core/src/frida-helper!frida-helper-64 \
			LOADER32=../../../../build/tmp-android-arm/frida-core/lib/loader/.libs/libfrida-loader.so!frida-loader-32.so \
			LOADER64=../../../../build/tmp-android-arm64/frida-core/lib/loader/.libs/libfrida-loader.so!frida-loader-64.so \
			AGENT32=../../../../build/tmp-android-arm/frida-core/lib/agent/.libs/libfrida-agent.so!frida-agent-32.so \
			AGENT64=../../../../build/tmp-android-arm64/frida-core/lib/agent/.libs/libfrida-agent.so!frida-agent-64.so
